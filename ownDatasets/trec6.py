...
class MyTREC6Dataset(Dataset):
    def __init__(self, hf_dataset, tokenizer, max_length=128, imbalance_factor=1.0):
        ...
        self.targets = torch.tensor(hf_dataset['coarse_label'], dtype=torch.long)
        
        # TREC-6 dataset has 6 coarse-grained classes
        self.classes = ['ABBR', 'ENTY', 'DESC', 'HUM', 'LOC', 'NUM']
        
        if imbalance_factor:
            # Extract texts and labels
            texts = hf_dataset['text']
            labels = hf_dataset['coarse_label']
