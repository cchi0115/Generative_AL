...
class MyYelpDataset(Dataset):
    def __init__(self, hf_dataset, tokenizer, max_length=128, imbalance_factor=1.0):
        ...
        # Yelp Review Full has text field and stars (1-5) as label
        self.data = hf_dataset['text']
        self.targets = torch.tensor(hf_dataset['label'], dtype=torch.long)
        
        # Yelp Review Full classes (1-5 stars)
        self.classes = ['1 star', '2 stars', '3 stars', '4 stars', '5 stars']
